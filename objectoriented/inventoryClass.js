    ...
    inventory1 = () => {
      ...
      switch (choice) {
        case 1: console.log("enter the options given down");
          ...
          let choice1 = parseInt(readline.question("Enter the option "));
          ...
          switch (choice1) {
            case 1:
              ...
              if (name == undefined || name == null || !isNaN(name) || validationRule.test(name) == true) {
                console.log("Value is undefined");
                return false;
              }
            ...
            case 2: var name = readline.question("Enter the name of wheat product you want to add");
              if (name == undefined || name == null || !isNaN(name) || validationRule.test(name) == true) {
                console.log("Value is undefined");
                return false;
              }
            ...
            case 3: var name = readline.question("Enter the name of wheat product you want to add");
              if (name == undefined || name == null || !isNaN(name) || validationRule.test(name) == true) {
                console.log("Value is undefined");
                return false;
              }
        ...
        case 2:
          ...
          switch (choice2) {
            ...
            case 2: var name = readline.question("Enter the name of wheat product you want to delete");
              if (name == undefined || name == null || !isNaN(name) || validationRule.test(name) == true) {
                console.log("Value is undefined");
                return false;
              }
              ...
              console.log(object);
              break;
            case 3: var name = readline.question("Enter the name of pulses product you want to delete");
              if (name == undefined || name == null || !isNaN(name) || validationRule.test(name) == true) {
                console.log("Value is undefined");
                return false;
              }
